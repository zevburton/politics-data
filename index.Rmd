...
I spent too long trying to figure out the donations that the NRA made to the campaigns of my Senators, so I decided to build my own dashboard. It's got the rounded donation numbers, the number of gun deaths in the state they represent, their NRA rating, and any comments they made to the New York Times about policy proporsals post-Uvalde.
